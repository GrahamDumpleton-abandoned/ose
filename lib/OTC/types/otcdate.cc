...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_Date::isValidDate(char const* theDateString)
{
  if (theDateString == 0)
    return OTCLIB_FALSE;
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_Date::convertToDate(
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_Date::isWeekDay() const
{
  switch (dayOfWeek())
  {
    case OTCLIB_SATURDAY:
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_Date::isFirstDayOfMonth() const
{
  int tmpDay;
  int tmpMonth;
  int tmpYear;
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_Date::isLastDayOfMonth() const
{
  int tmpDay;
  int tmpMonth;
  int tmpYear;
