    ...
    seconds_(0)
{
  ...
  OTCLIB_ENSURE_FN((theResult != OTCLIB_FALSE),
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_Duration::convertToDuration(
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_Duration::isValidDuration(char const* theDurationString)
{
  int theDays = 0;
  int theHours = 0;
  int theMinutes = 0;
