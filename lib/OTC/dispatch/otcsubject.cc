...
void OTC_Subject::addObserver(int theAgentId, char const* theSubject)
{
  ...
  OTC_Boolean theExists;
  theExists = OTCLIB_FALSE;
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_Subject::observersExist() const
{
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_Subject::observersExist(char const* theSubject) const
{
  OTC_Boolean theResult;
