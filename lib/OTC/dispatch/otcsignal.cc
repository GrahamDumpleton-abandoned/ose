...
OTC_Boolean OTCEV_Signal::gSignalsLost_ = OTCLIB_FALSE;
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTCEV_Signal::isPending()
{
...
void OTCEV_Signal::fill_(OTC_JobList* theJobQueue)
{
  ...
  if (gSignalsLost_ != OTCLIB_FALSE)
  {
    gSignalsLost_ = OTCLIB_FALSE;
