...
extern "C" int select(int,fd_set*,fd_set*,fd_set*,const timeval*);
 ...
 && !defined(hpux) && !defined(__NetBSD__) \
 && !defined (__FreeBSD__)
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_JobQueue::isWaiting()
{
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_JobQueue::isRunning()
{
  OTC_Boolean theResult;
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_JobQueue::isStopped()
{
  OTC_Boolean theResult;
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_JobQueue::isPriorityJobsEmpty()
{
  OTC_Boolean theResult;
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_JobQueue::isStandardJobsEmpty()
{
  OTC_Boolean theResult;
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_JobQueue::isPendingStandardJobsEmpty()
{
  OTC_Boolean theResult;
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_JobQueue::isIdleJobsEmpty()
{
  OTC_Boolean theResult;
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_JobQueue::isPendingIdleJobsEmpty()
{
  OTC_Boolean theResult;
