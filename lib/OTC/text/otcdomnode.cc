    ...
    lastProperty_(0), firstChild_(0), lastChild_(0), numChildren_(0)
{
  ...
  {
    u_int theLength = strlen(theName);
...
/* ------------------------------------------------------------------------- */
void OTC_DOMNode::setName(char const* theName, u_int theLength)
{
  OTCLIB_ENSURE_FN((theName != 0 || theLength == 0),
   "OTC_DOMNode::setName(char const*,u_int)",
   "invalid string");
...
/* ------------------------------------------------------------------------- */
void OTC_DOMNode::setContent(char const* theContent, u_int theLength)
{
  OTCLIB_ENSURE_FN((theContent != 0 || theLength == 0),
   "OTC_DOMNode::setContent(char const*,u_int)",
   "invalid string");
...
/* ------------------------------------------------------------------------- */
OTC_DOMNode* OTC_DOMNode::findNode_(char const* theName, u_int theLength) const
{
  OTCLIB_ENSURE_FN((theName != 0),
   "OTC_DOMNode::findNode_(char const*,u_int)",
   "invalid name string");
...
{
  OTCLIB_ENSURE_FN((theName != 0),
   "OTC_DOMNode::property_(char const*,char const*,u_int)",
   "invalid name string");
  OTCLIB_ENSURE_FN((theValue != 0),
   "OTC_DOMNode::property_(char const*,char const*,u_int)",
   "invalid value string");
...
{
  OTCLIB_ENSURE_FN((theName != 0),
   "OTC_DOMNode::findProperty_(char const*,char const*,u_int)",
   "invalid name string");
  OTCLIB_ENSURE_FN((theValue != 0),
   "OTC_DOMNode::findProperty_(char const*,char const*,u_int)",
   "invalid value string");
...
{
  OTCLIB_ENSURE_FN((theName != 0),
   "OTC_DOMNode::findChild_(char const*,u_int)",
   "invalid name string");
...
{
  OTCLIB_ENSURE_FN((theName != 0),
   "OTC_DOMNode::findSibling_(char const*,u_int)",
   "invalid name string");
