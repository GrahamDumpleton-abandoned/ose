...
/* ------------------------------------------------------------------------- */
os_typespec* OTC_Properties::typespec()
{
  static os_typespec ts("OTC_Properties");
  return &ts;
}
#endif
...
)
{
  ...
  OTC_Boolean isComment;
  isComment = OTCLIB_FALSE;
  ...
  while (theStream.good())
  {
    ...
    theLine.readLine(theStream,OTCLIB_FALSE);
...
/* ------------------------------------------------------------------------- */
OTC_Boolean OTC_Properties::matchPattern_(
