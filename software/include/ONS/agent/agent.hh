  ...
  public:
    ...
    void		subscribeStartup(void (T::*theMethod)() const)
				  ...
				  ONS_EventCallback* theCallback =
				   ONS_EventCallbackFactory<TOBJ,
				   T>::create(derivedObject<TOBJ,
				   T>(this),theMethod);
    ...
    void		subscribeShutdown(
			 void (T::*theMethod)(OTC_ShutdownNotification) const
    				...
    				{
				  ONS_EventCallback* theCallback =
				   ONS_ShutdownCallbackFactory<TOBJ,
				   T>::create(derivedObject<TOBJ,
				   T>(this),theMethod);
    ...
    void		subscribeSignal(
			 ...
			 int theSignal
    				...
    				{
				  ONS_EventCallback* theCallback =
				   ONS_SignalCallbackFactory<TOBJ,
				   T>::create(derivedObject<TOBJ,
				   T>(this),theMethod);
    ...
    OTC_String		startTimer(
			 ...
			 char const* theTimer=0
    				...
    				{
				  ONS_EventCallback* theCallback =
				   ONS_TimeoutCallbackFactory<TOBJ,
				   T>::create(derivedObject<TOBJ,
				   T>(this),theMethod);
    ...
    OTC_String		scheduleAction(
			 ...
			 char const* theAction=0
    				...
    				{
				  ONS_EventCallback* theCallback =
				   ONS_ActionCallbackFactory<TOBJ,
				   T>::create(derivedObject<TOBJ,
				   T>(this),theMethod);
    ...
    void		subscribeSocket(
			 ...
			 int theEvents=OTCLIB_POLLIN
    				...
    				{
				  ONS_EventCallback* theCallback =
				   ONS_SocketCallbackFactory<TOBJ,
				   T>::create(derivedObject<TOBJ,
				   T>(this),theMethod);
