  ...
  public:
			 ...
			 char const* theMethodName
			)
				{
				  ONS_EventCallback* theCallback =
				   ONS_RequestCallbackFactory<TOBJ,
    ...
    void		processResponse(
			 ...
			 OTC_String const& theConversationId
				...
				{
				  ONS_EventCallback* theCallback =
				   ONS_ResponseCallbackFactory<TOBJ,
				   T>::create(derivedObject<TOBJ,
				   T>(this),theMethod);
    ...
    void		processFailure(
			 ...
			 double theResponseTimeout=0.0
				...
				{
				  ONS_EventCallback* theCallback =
				   ONS_FailureCallbackFactory<TOBJ,
				   T>::create(derivedObject<TOBJ,
				   T>(this),theMethod);
    ...
    void		monitorReports(
			 ...
			 char const* theSubjectPattern
				...
				{
				  ONS_EventCallback* theCallback =
				   ONS_ReportCallbackFactory<TOBJ,
				   T>::create(derivedObject<TOBJ,
				   T>(this),theMethod);
    ...
    void		suspendResponse(void (T::*theMethod)() const)
				{
				  ONS_EventCallback* theCallback =
				   ONS_DelayedCallbackFactory<TOBJ,
				   T>::create(derivedObject<TOBJ,
				   T>(this),theMethod);
    ...
    void		processMessages(
			 ...
			 char const* theMessageId
				...
				{
				  ONS_EventCallback* theCallback =
				   ONS_OpaqueCallbackFactory<TOBJ,
				   T>::create(derivedObject<TOBJ,
				   T>(this),theMethod);
