#ifndef OTC_INTERNET_JSONGTWY_HH
#define OTC_INTERNET_JSONGTWY_HH
/*
// ============================================================================
//
// = LIBRARY
...
#pragma interface "OTC/internet/jsongtwy.hh"
#endif
#endif

/* ------------------------------------------------------------------------- */

class OSE_EXPORT OTC_JsonRpcGateway : public OTC_HttpServer, public OTC_EVAgent
    // = TITLE
    ...
    //     
    // = SEE ALSO
    //     <OTC_HttpDaemon>, <OTC_JsonRpcServlet>, <OTC_HttpServer>
{
  public:

    virtual		~OTC_JsonRpcGateway();
  ...
  private:
			...
			OTC_JsonRpcGateway(OTC_JsonRpcGateway const&);
				// Do not define an implementation for this.

    OTC_JsonRpcGateway&	operator=(OTC_JsonRpcGateway const&);
				// Do not define an implementation for this.
...
#endif /* OTC_INTERNET_JSONGTWY_HH */
