...
Publisher::Publisher()
  : broker_(this,"BACKEND:SEED","BACKEND")
{
  // The service broker is initialised above so
  // that this agent has service name "BACKEND:SEED".
  // The service audience is set of "BACKEND"
  // so that this publisher cannot be seen
  // outside of exchange group with corresponding
  // name.
...
int main(int argc, char* argv[])
{
  ...
  OTC_Exchange theExchange(OTCLIB_EXCHANGE_CLIENT,"BACKEND");
