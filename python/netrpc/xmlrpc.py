...
# using the "netrpc" module, you will not loose any type information.
...
from common import _stringTypes
...
class _Decoder:
  ...
  def end(self,tag):
	...
	dict[self._decode("xsd:string",names[i])] = items[i]
