    ...
    //     <OTC_DOMProperty>
{
  ...
  public:
    ...
    void		setName(char const* theName, u_int theLength);
    ...
    void		setContent(char const* theContent, u_int theLength);
    ...
    OTC_Boolean		hasProperties() const
				{ return firstProperty_ != 0; }
				// Returns <OTCLIB_TRUE> if this node has
    ...
    OTC_DOMNode*	findNode(char const* theName, u_int theLength)
    ...
    OTC_DOMNode const*	findNode(char const* theName, u_int theLength) const
      				{ return findNode_(theName,theLength); }
    				// Does a preorder traversal of the subtree
				// rooted at this node and returns the first
				// node found which has a name matching the
    ...
    OTC_DOMNode*	findChild(char const* theName, u_int theLength)
    ...
    OTC_DOMNode const*	findChild(char const* theName, u_int theLength) const
      				{ return findChild_(theName,theLength); }
    				// Returns the first child node of this
				// node which has a name matching the first
				// <theLength> characters of <theName> or <0>
    ...
    OTC_DOMNode*	findSibling(char const* theName, u_int theLength)
  ...
  private:
    ...
    OTC_DOMNode*	findNode_(char const* theName, u_int theLength) const;
    				// Does a preorder traversal of the subtree
				// rooted at this node and returns the first
				// node found which has a name matching the
				// first <theLength> characters of <theName>.
    ...
    OTC_DOMNode*	findChild_(char const* theName, u_int theLength) const;
    				// Returns the first child node of this
				// node which has a name matching the first
				// <theLength> characters of <theName> or <0>
				// if no such child node exists. Raises an
