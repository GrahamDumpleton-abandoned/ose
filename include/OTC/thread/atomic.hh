...
// OSE. It is recommended they aren't used
// directly, especially since they don't do
// anything special when threading support
// isn't compiler into OSE.

// Note that <OTC_Atomic> may resolved to an
// unsigned value so do assume it can handle
// negative values.
