    ...
    //	   <OTC_Properties>
{
  public:
    ...
    static OTC_String const&	lookupConfig(char const* theKey);
				...
				// <isUndefined()> will return <OTCLIB_TRUE>.
				// You can also compare the string against
    ...
    static OTC_Boolean	threadingEnabled();
				// Returns <OTCLIB_TRUE> if threading support
				// has been compiled into this library.
