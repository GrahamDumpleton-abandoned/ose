    ...
    //     <OTC_EVAgent>, <OTC_Event>
{
  ...
  public:
			...
			)
				{
				  return schedule(theAgentId,
				   theType,0,theAgentData);
                                ...
                                // This prototype is defined in place of
                                // that above when <OTCLIB_60000_MIGRATION>
                                // is defined. It is used to capture change
                                // in value for default argument. Calls
                                // using default argument will fail to
                                // compile when this prototype is used.
    ...
    static OTC_Boolean	matches(char const* theDescription, time_t theTime);
				// Returns <OTCLIB_TRUE> if the cron type
