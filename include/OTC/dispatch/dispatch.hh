    ...
    //     <OTC_JobQueue>, <OTC_Job>
{
  public:
...
#if !defined(OTCLIB_60000_MIGRATION)
    ...
    static void		schedule(OTC_Job* theJob, int theType);
				// This prototype is defined in place of that
				// above when <OTCLIB_60000_MIGRATION> is
				// defined. It is used to capture change in
				// value for default argument. Calls using
				// default argument will fail to compile when
				// this prototype is used.
