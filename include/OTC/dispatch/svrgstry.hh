    ...
    //     <OTC_ServiceBinding>, <OTCEV_ServiceAnnouncement>, <OTC_SVBroker>
{
  public:
    ...
    OTC_ServiceBinding*	addServiceBinding(
				...
				// Adds new service defined to the registry
				// and generates a service available
				// announcement to parties interested in the
				// registry. If a service with the same
				// service address is already known of, an
				// exception is raised.
