...
#if !defined(ENV_NOEVENTTHREADS)
#if defined(ENV_THREADS)
#define ENV_EVENTTHREADS 1
#endif
#endif
    ...
    //	   <OTC_Event>, <OTC_EVAgent>, <OTC_EVHandler>, <OTC_EVCallback>
{
  ...
  private:
    ...
    OTC_Boolean		suspended_;
				// Will be <OTCLIB_TRUE> if handling of
				// new events by threads is suspended.

    OTC_Boolean		shutdown_;
				// Will be <OTCLIB_TRUE> if handling of
				// events has been shutdown.
