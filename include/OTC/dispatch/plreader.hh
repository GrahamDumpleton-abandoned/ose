    ...
    //     <OTC_ROPayload>, <OTC_RWPayload>, <OTC_SVPayload>
{
  public:
    ...
    OTC_Boolean		errorOccurred() const
      				{ return status_ == OTCLIB_FALSE; }
    				// Returns <OTCLIB_TRUE> if an error has
				// been flagged.

    void		flagError()
      				{ status_ = OTCLIB_FALSE; }
  ...
  private:
    ...
    OTC_Boolean&	status_;
				...
				// have occurred. If <OTCLIB_TRUE> all is
				// still okay.
};
