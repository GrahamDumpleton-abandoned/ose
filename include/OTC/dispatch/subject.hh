    ...
    //     <OTC_Event>
{
  public:
    ...
    OTC_Boolean		observersExist() const;
				// Returns <OTCLIB_TRUE> if any observers
				// have been registered against this object.

    OTC_Boolean		observersExist(char const* theSubject) const;
				// Returns <OTCLIB_TRUE> if any observers
				// have been registered against this object
				// which have defined a pattern which would
				// match <theSubject>.
