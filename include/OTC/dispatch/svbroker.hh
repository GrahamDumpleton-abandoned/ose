    ...
    //     <OTCEV_Report>, <OTCEV_Failure>, <OTC_SVPayload>
{
  public:
    ...
    // = INITIALISATION
			...
			OTC_SVBroker(
			 ...
			 char const* theServiceAudience="*"
				...
				// processes is possible. Other values for
    ...
    virtual OTC_Boolean matchSubject(
                         char const* theSubjectPattern,
                         char const* theSubjectName
                        ) const;
				// If <theSubjectPattern> matches
				// <theSubjectName> returns <OTCLIB_TRUE>.
  ...
  private:
    ...
    OTC_Boolean		builtinRequest_(OTCEV_Request* theEnvelope);
				// Responds to builtin requests methods,
				// returning <OTCLIB_TRUE> if the request was
				// handled and <OTCLIB_FALSE> otherwise. If
				// the request wasn't handled, it should be
    ...
    OTC_Receiver        inBox_;
				...
				// anonymous name to the assoctiated agent.
