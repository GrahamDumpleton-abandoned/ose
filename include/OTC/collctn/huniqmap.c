...
#if defined(ENV_OSTORE)
  keyIndex_ = new (theLocality,OTC_HashTable::get_os_typespec()) OTC_HashTable;
#else
...
#if defined(ENV_OSTORE)
  itemIndex_ = new (theLocality,OTC_HashTable::get_os_typespec()) OTC_HashTable;
#else
...
#if defined(ENV_OSTORE)
  itemIndex_ = new (theLocality,OTC_HashTable::get_os_typespec())
OTC_HashTable;
#else
  itemIndex_ = new OTC_HashTable;
#endif
...
/* ------------------------------------------------------------------------- */
template<class T1, class T2>
OTC_Boolean OTC_HUniqMap<T1,T2>::containsKey(T1 const& theKey) const
{
  int tmpRank;
  int tmpHashValue;
...
/* ------------------------------------------------------------------------- */
template<class T1, class T2>
OTC_Boolean OTC_HUniqMap<T1,T2>::containsItem(T2 const& theItem) const
{
  int tmpRank;
  int tmpHashValue;
  u_int tmpIteration = 0;
