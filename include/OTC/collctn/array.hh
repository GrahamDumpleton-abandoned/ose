    ...
    //     <OTC_PairVisitor>
{
  public:
    ...
    //     required, for example, to avoid grabbing a write lock when using
    //     ObjectStore, a second argument can be passed to the following
    //     functions. The value of this argument is either <OTCLIB_SAFE> or
