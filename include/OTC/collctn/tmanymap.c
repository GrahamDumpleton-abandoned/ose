...
/* ------------------------------------------------------------------------- */
template<class T1, class T2>
OTC_Boolean OTC_TManyMap<T1,T2>::containsKey(T1 const& theKey) const
{
  OTC_AVLTreeNode* theIndexNode;
  theIndexNode = (OTC_AVLTreeNode*)index_->root();
...
/* ------------------------------------------------------------------------- */
template<class T1, class T2>
OTC_Boolean OTC_TManyMap<T1,T2>::contains(
 T1 const& theKey,
 T2 const& theItem
) const
{
...
) const
{
  ...
  theIter = new (theLocality,
   ...
   OTC_ItemCursor< T2,OTC_PairBucket<T1,T2> >(list_,
...
) const
{
  ...
  theIter = new (theLocality,
   OTC_KeyItemCursor< T1,T2,OTC_PairBucket<T1,T2> >::get_os_typespec())
   OTC_KeyItemCursor< T1,T2,OTC_PairBucket<T1,T2> >(list_,
   theStartLink,theEndLink,theDirection,theProtection);
#else
  theIter = new OTC_KeyItemCursor< T1,T2,OTC_PairBucket<T1,T2> >(
   list_,theStartLink,theEndLink,theDirection,theProtection);
