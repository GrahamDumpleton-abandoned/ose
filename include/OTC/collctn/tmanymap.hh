    ...
    //     <OTC_RankActions>, <OTC_PairIterator>
{
  public:
    ...
    OTC_Boolean		isEmpty() const
				...
				// Returns <OTCLIB_TRUE> if the map is empty.
    ...
    OTC_Boolean		contains(T1 const& theKey, T2 const& theItem) const;
				// Returns <TRUE> if the map contains
    ...
    //     grabbing a write lock when using ObjectStore, an extra
