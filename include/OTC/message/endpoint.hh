    ...
    //     <OTC_EPServer>, <OTC_EPClient>, <OTC_EPInterface>, <OTC_Subject>
{
  ...
  public:
    ...
    OTC_Boolean		isConnected() const
				{ return !inBox_.name().isEmpty(); }
				// Returns <OTCLIB_TRUE> if this endpoint is
				// one end of an active connection. Whether
				// the connection is active is deduced from
