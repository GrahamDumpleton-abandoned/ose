    ...
    //     the original message being lost.
{
  public:
    ...
    static OTC_Boolean	stderrOutputEnabled();
    ...
    static OTC_Boolean	longFormatEnabled();
				// Returns <OTCLIB_TRUE> if output of long
				// format log message prefix is enabled.
				// By default it isn't, unless overridden
  ...
  private:
    ...
    static OTC_Boolean	initialised_;
				// <OTCLIB_TRUE> if the class has been
				// initialised.

    static OTC_Boolean	useStderr_;
				// <OTCLIB_TRUE> if logging is to be sent to
				// standard error.
    ...
    static OTC_Boolean	appendLogFile_;
				// <OTCLIB_TRUE> if log entries should be
    ...
    static OTC_Boolean	longFormat_;
				// <OTCLIB_TRUE> if long format error message
				// should be used.
