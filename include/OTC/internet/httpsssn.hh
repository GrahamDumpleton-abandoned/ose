    ...
    //     <OTC_HttpDaemon>, <OTC_HttpServlet>
{
  ...
  public:
    ...
    OTC_Boolean		containsHeader(char const* theName) const
				{ return headers_.contains(theName); }
				// Returns <OTCLIB_TRUE> if header with
				// <theName> is included. <theName> must
  ...
  public:
    ...
    static OTC_Boolean	xmlDecode(
			 ...
			 OTC_String& theResult
				...
				// the function returning <OTCLIB_TRUE> if
  ...
  private:
    ...
    static OTC_Boolean	gInitialised_;
