#ifndef OTC_PYTHON_PYHTTPSL_HH
#define OTC_PYTHON_PYHTTPSL_HH
/*
// ============================================================================
//
// = LIBRARY
...
class OSE_EXPORT OTC_PyHttpServlet : public PyObject,
 public OTC_HttpServlet, public OTC_EVAgent
{
  ...
  private:
			...
			OTC_PyHttpServlet(OTC_PyHttpServlet const&);

    OTC_PyHttpServlet&	operator=(OTC_PyHttpServlet const&);
